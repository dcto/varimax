...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     */
    public function router($id, $parameters = [], $absolute = true)
    {
        return $this->route($id, $parameters, $absolute);
    }
    /**
     * Get the URL to a named route.
     *
     ...
     * @throws \InvalidArgumentException
     */
    public function route($id, $parameters = [], $absolute = true)
    {
        if ($route = \Router::route($id)) {
            return \Request::baseUrl().$route->args($parameters)->url();
        }

        throw new InvalidArgumentException("Route [{$id}] not defined.");
    }
     ...
     * @return void
     */
    public function setRequest(\VM\Http\Request $request)
    {
