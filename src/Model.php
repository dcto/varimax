 ...
 * @method static \Illuminate\Contracts\Pagination\LengthAwarePaginator|\Illuminate\Database\Eloquent\Collection paginate(int $perPage = null, array $columns = array('*'), string $pageName = 'page', int|null $page = null)
 * @method $this \Illuminate\Contracts\Pagination\LengthAwarePaginator|\Illuminate\Database\Eloquent\Collection paginate(int $perPage = null, array $columns = array('*'), string $pageName = 'page', int|null $page = null)
 * @method static \Illuminate\Contracts\Pagination\Paginator|\Illuminate\Database\Eloquent\Collection simplePaginate(int $perPage = null, array $columns = array('*'), string $pageName = 'page')
