 ...
 * @method static \VM\Model|\Illuminate\Database\Eloquent\Builder when($value, $callback)
 * @method static \VM\Model|\Illuminate\Database\Eloquent\Builder where(string $column, string $operator = null, mixed $value = null, string $boolean = 'and')
