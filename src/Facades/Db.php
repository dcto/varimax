 ...
 * @method static \Illuminate\Database\Query\Builder table(\Illuminate\Database\Query\Builder|string $table, string|null $as = null)
 ...
 * @method static void whenQueryingForLongerThan(\Carbon\CarbonInterval|float|int $threshold, callable $handler)
 ...
 * @method static \Closure|null getRawPdo()
 * @method static \PDO getReadPdo()
 * @method static \Closure|null getRawReadPdo()
 * @method static \Illuminate\Database\Connection setPdo(\Closure|null $pdo)
 * @method static \Illuminate\Database\Connection setReadPdo(\Closure|null $pdo)
